...
import { ScrollbarGeometry, ScrollbarPosition } from '@finvest/directives/scrollbar/scrollbar.types';
...
export class FinvestScrollbarDirective implements OnChanges, OnInit, OnDestroy {
